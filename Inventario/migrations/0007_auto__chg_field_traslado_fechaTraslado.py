...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Traslado.fechaTraslado'
        db.alter_column(u'Inventario_traslado', 'fechaTraslado', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Traslado.fechaTraslado'
        db.alter_column(u'Inventario_traslado', 'fechaTraslado', self.gf('django.db.models.fields.DateField')(auto_now=True))
