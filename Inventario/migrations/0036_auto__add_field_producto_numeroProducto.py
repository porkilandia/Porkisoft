...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producto.numeroProducto'
        db.add_column(u'Inventario_producto', 'numeroProducto',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producto.numeroProducto'
        db.delete_column(u'Inventario_producto', 'numeroProducto')
