...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ajustes.fechaAjuste'
        db.alter_column(u'Inventario_ajustes', 'fechaAjuste', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Ajustes.fechaAjuste'
        db.alter_column(u'Inventario_ajustes', 'fechaAjuste', self.gf('django.db.models.fields.DateField')())
