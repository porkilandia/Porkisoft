...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Producto.utilidadProducto'
        db.delete_column(u'Inventario_producto', 'utilidadProducto')

        # Deleting field 'Producto.rentabilidadProducto'
        db.delete_column(u'Inventario_producto', 'rentabilidadProducto')

        # Adding field 'Producto.precioSugerido'
        db.add_column(u'Inventario_producto', 'precioSugerido',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Producto.utilidadProducto'
        db.add_column(u'Inventario_producto', 'utilidadProducto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.rentabilidadProducto'
        db.add_column(u'Inventario_producto', 'rentabilidadProducto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Producto.precioSugerido'
        db.delete_column(u'Inventario_producto', 'precioSugerido')
