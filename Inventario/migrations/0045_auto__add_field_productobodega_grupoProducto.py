...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductoBodega.grupoProducto'
        db.add_column(u'Inventario_productobodega', 'grupoProducto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductoBodega.grupoProducto'
        db.delete_column(u'Inventario_productobodega', 'grupoProducto')
    ...
    models = {
        ...
        u'Inventario.productobodega': {
            ...
            'grupoProducto': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
