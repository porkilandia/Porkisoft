...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductoBodega.pesoProductoStock'
        db.alter_column(u'Inventario_productobodega', 'pesoProductoStock', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ProductoBodega.pesoProductoStock'
        db.alter_column(u'Inventario_productobodega', 'pesoProductoStock', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))
