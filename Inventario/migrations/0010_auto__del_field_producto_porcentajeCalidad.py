...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Producto.porcentajeCalidad'
        db.delete_column(u'Inventario_producto', 'porcentajeCalidad')


    def backwards(self, orm):
        # Adding field 'Producto.porcentajeCalidad'
        db.add_column(u'Inventario_producto', 'porcentajeCalidad',
