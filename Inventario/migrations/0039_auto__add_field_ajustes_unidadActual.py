...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ajustes.unidadActual'
        db.add_column(u'Inventario_ajustes', 'unidadActual',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ajustes.unidadActual'
        db.delete_column(u'Inventario_ajustes', 'unidadActual')
