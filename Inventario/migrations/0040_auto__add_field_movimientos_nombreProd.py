...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movimientos.nombreProd'
        db.add_column(u'Inventario_movimientos', 'nombreProd',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movimientos.nombreProd'
        db.delete_column(u'Inventario_movimientos', 'nombreProd')
