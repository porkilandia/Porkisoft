...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ajustes'
        db.create_table(u'Inventario_ajustes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaAjuste', self.gf('django.db.models.fields.DateField')()),
            ('productoAjuste', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('bodegaAjuste', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Bodega'])),
            ('pesoAjuste', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
        ...
        db.send_create_signal(u'Inventario', ['Ajustes'])


    def backwards(self, orm):
        # Deleting model 'Ajustes'
        db.delete_table(u'Inventario_ajustes')
    ...
    models = {
        u'Inventario.ajustes': {
            ...
            'fechaAjuste': ('django.db.models.fields.DateField', [], {}),
