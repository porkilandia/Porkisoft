...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movimientos.productoMov'
        db.add_column(u'Inventario_movimientos', 'productoMov',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movimientos.productoMov'
        db.delete_column(u'Inventario_movimientos', 'productoMov_id')
