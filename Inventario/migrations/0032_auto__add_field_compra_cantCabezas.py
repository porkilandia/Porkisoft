...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compra.cantCabezas'
        db.add_column(u'Inventario_compra', 'cantCabezas',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compra.cantCabezas'
        db.delete_column(u'Inventario_compra', 'cantCabezas')
