...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanillaRecepcion.vrTransporte'
        db.add_column(u'Inventario_planillarecepcion', 'vrTransporte',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanillaRecepcion.vrTransporte'
        db.delete_column(u'Inventario_planillarecepcion', 'vrTransporte')
