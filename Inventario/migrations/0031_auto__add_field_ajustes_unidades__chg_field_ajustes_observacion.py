...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ajustes.unidades'
        db.add_column(u'Inventario_ajustes', 'unidades',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


        # Changing field 'Ajustes.observacion'
        db.alter_column(u'Inventario_ajustes', 'observacion', self.gf('django.db.models.fields.TextField')(max_length=150))

    def backwards(self, orm):
        # Deleting field 'Ajustes.unidades'
        db.delete_column(u'Inventario_ajustes', 'unidades')


        # Changing field 'Ajustes.observacion'
        db.alter_column(u'Inventario_ajustes', 'observacion', self.gf('django.db.models.fields.CharField')(max_length=200))
