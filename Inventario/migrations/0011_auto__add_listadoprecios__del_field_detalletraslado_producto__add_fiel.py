...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListadoPrecios'
        db.create_table(u'Inventario_listadoprecios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombreLista', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'Inventario', ['ListadoPrecios'])

        # Deleting field 'DetalleTraslado.producto'
        db.delete_column(u'Inventario_detalletraslado', 'producto_id')

        # Adding field 'DetalleTraslado.productoTraslado'
        db.add_column(u'Inventario_detalletraslado', 'productoTraslado',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ListadoPrecios'
        db.delete_table(u'Inventario_listadoprecios')

        # Adding field 'DetalleTraslado.producto'
        db.add_column(u'Inventario_detalletraslado', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DetalleTraslado.productoTraslado'
        db.delete_column(u'Inventario_detalletraslado', 'productoTraslado_id')
