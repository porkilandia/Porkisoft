...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Movimientos.salida'
        db.delete_column(u'Inventario_movimientos', 'salida')

        # Deleting field 'Movimientos.entrada'
        db.delete_column(u'Inventario_movimientos', 'entrada')


    def backwards(self, orm):
        # Adding field 'Movimientos.salida'
        db.add_column(u'Inventario_movimientos', 'salida',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Movimientos.entrada'
        db.add_column(u'Inventario_movimientos', 'entrada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
