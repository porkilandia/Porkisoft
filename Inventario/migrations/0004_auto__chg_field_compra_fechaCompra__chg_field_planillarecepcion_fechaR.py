...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compra.fechaCompra'
        db.alter_column(u'Inventario_compra', 'fechaCompra', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'PlanillaRecepcion.fechaRecepcion'
        db.alter_column(u'Inventario_planillarecepcion', 'fechaRecepcion', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Compra.fechaCompra'
        db.alter_column(u'Inventario_compra', 'fechaCompra', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True))

        # Changing field 'PlanillaRecepcion.fechaRecepcion'
        db.alter_column(u'Inventario_planillarecepcion', 'fechaRecepcion', self.gf('django.db.models.fields.DateField')(auto_now=True))
