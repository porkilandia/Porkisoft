...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanillaRecepcion.vrKiloCanal'
        db.add_column(u'Inventario_planillarecepcion', 'vrKiloCanal',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanillaRecepcion.vrKiloCanal'
        db.delete_column(u'Inventario_planillarecepcion', 'vrKiloCanal')
