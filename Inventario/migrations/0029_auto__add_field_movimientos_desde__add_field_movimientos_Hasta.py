...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movimientos.desde'
        db.add_column(u'Inventario_movimientos', 'desde',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Movimientos.Hasta'
        db.add_column(u'Inventario_movimientos', 'Hasta',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movimientos.desde'
        db.delete_column(u'Inventario_movimientos', 'desde')

        # Deleting field 'Movimientos.Hasta'
        db.delete_column(u'Inventario_movimientos', 'Hasta')
