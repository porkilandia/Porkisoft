...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Inventario_movimientos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('fechaMov', self.gf('django.db.models.fields.DateField')()),
            ('entrada', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('salida', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Inventario', ['Movimientos'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Inventario_movimientos')
    ...
    models = {
        ...
        u'Inventario.movimientos': {
            ...
            'entrada': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'fechaMov': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'salida': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
