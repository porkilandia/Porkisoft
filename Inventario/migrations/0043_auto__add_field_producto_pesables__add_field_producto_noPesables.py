...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producto.pesables'
        db.add_column(u'Inventario_producto', 'pesables',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Producto.noPesables'
        db.add_column(u'Inventario_producto', 'noPesables',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producto.pesables'
        db.delete_column(u'Inventario_producto', 'pesables')

        # Deleting field 'Producto.noPesables'
        db.delete_column(u'Inventario_producto', 'noPesables')
    ...
    models = {
        ...
        u'Inventario.ganado': {
            ...
            'TotalpesoEnPie': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '3'}),
