...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleCompra.pesoDescongelado'
        db.add_column(u'Inventario_detallecompra', 'pesoDescongelado',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3),
                      keep_default=False)

        # Adding field 'DetalleCompra.vrKiloDescongelado'
        db.add_column(u'Inventario_detallecompra', 'vrKiloDescongelado',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleCompra.pesoDescongelado'
        db.delete_column(u'Inventario_detallecompra', 'pesoDescongelado')

        # Deleting field 'DetalleCompra.vrKiloDescongelado'
        db.delete_column(u'Inventario_detallecompra', 'vrKiloDescongelado')
