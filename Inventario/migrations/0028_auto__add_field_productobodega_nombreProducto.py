...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductoBodega.nombreProducto'
        db.add_column(u'Inventario_productobodega', 'nombreProducto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductoBodega.nombreProducto'
        db.delete_column(u'Inventario_productobodega', 'nombreProducto')
