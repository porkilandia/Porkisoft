...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Producto.vrVentaProducto'
        db.delete_column(u'Inventario_producto', 'vrVentaProducto')

        # Adding field 'Producto.vrVentaLorenzo'
        db.add_column(u'Inventario_producto', 'vrVentaLorenzo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.vrVentaCentro'
        db.add_column(u'Inventario_producto', 'vrVentaCentro',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.vrVentaPotrerillo'
        db.add_column(u'Inventario_producto', 'vrVentaPotrerillo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.vrVentaNorte'
        db.add_column(u'Inventario_producto', 'vrVentaNorte',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.vrVentaContado'
        db.add_column(u'Inventario_producto', 'vrVentaContado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Producto.vrVentaCredito'
        db.add_column(u'Inventario_producto', 'vrVentaCredito',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Producto.vrVentaProducto'
        db.add_column(u'Inventario_producto', 'vrVentaProducto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Producto.vrVentaLorenzo'
        db.delete_column(u'Inventario_producto', 'vrVentaLorenzo')

        # Deleting field 'Producto.vrVentaCentro'
        db.delete_column(u'Inventario_producto', 'vrVentaCentro')

        # Deleting field 'Producto.vrVentaPotrerillo'
        db.delete_column(u'Inventario_producto', 'vrVentaPotrerillo')

        # Deleting field 'Producto.vrVentaNorte'
        db.delete_column(u'Inventario_producto', 'vrVentaNorte')

        # Deleting field 'Producto.vrVentaContado'
        db.delete_column(u'Inventario_producto', 'vrVentaContado')

        # Deleting field 'Producto.vrVentaCredito'
        db.delete_column(u'Inventario_producto', 'vrVentaCredito')
