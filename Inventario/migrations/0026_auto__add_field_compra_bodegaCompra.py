...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compra.bodegaCompra'
        db.add_column(u'Inventario_compra', 'bodegaCompra',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['Inventario.Bodega'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compra.bodegaCompra'
        db.delete_column(u'Inventario_compra', 'bodegaCompra_id')
