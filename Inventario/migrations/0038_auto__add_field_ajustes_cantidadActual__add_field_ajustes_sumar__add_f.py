...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ajustes.cantidadActual'
        db.add_column(u'Inventario_ajustes', 'cantidadActual',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Adding field 'Ajustes.sumar'
        db.add_column(u'Inventario_ajustes', 'sumar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ajustes.restar'
        db.add_column(u'Inventario_ajustes', 'restar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ajustes.cantidadActual'
        db.delete_column(u'Inventario_ajustes', 'cantidadActual')

        # Deleting field 'Ajustes.sumar'
        db.delete_column(u'Inventario_ajustes', 'sumar')

        # Deleting field 'Ajustes.restar'
        db.delete_column(u'Inventario_ajustes', 'restar')
