...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductoBodega.deshidratacion'
        db.alter_column(u'Inventario_productobodega', 'deshidratacion', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'ProductoBodega.deshidratacion'
        db.alter_column(u'Inventario_productobodega', 'deshidratacion', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))
    ...
    models = {
        ...
        u'Inventario.productobodega': {
            ...
            'deshidratacion': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
