...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Traslado.guardado'
        db.add_column(u'Inventario_traslado', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Traslado.guardado'
        db.delete_column(u'Inventario_traslado', 'guardado')
