...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Producto.deshidratacion'
        db.delete_column(u'Inventario_producto', 'deshidratacion')

        # Adding field 'ProductoBodega.deshidratacion'
        db.add_column(u'Inventario_productobodega', 'deshidratacion',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Producto.deshidratacion'
        db.add_column(u'Inventario_producto', 'deshidratacion',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Deleting field 'ProductoBodega.deshidratacion'
        db.delete_column(u'Inventario_productobodega', 'deshidratacion')
    ...
    models = {
        ...
        u'Inventario.productobodega': {
            ...
            'deshidratacion': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
