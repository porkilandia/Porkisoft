...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producto.gravado2'
        db.add_column(u'Inventario_producto', 'gravado2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producto.gravado2'
        db.delete_column(u'Inventario_producto', 'gravado2')
