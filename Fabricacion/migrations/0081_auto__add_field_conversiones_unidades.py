...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversiones.unidades'
        db.add_column(u'Fabricacion_conversiones', 'unidades',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversiones.unidades'
        db.delete_column(u'Fabricacion_conversiones', 'unidades')
