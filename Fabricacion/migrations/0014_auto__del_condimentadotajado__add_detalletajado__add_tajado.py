...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DetalleTajado'
        db.create_table(u'Fabricacion_detalletajado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tajado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Fabricacion.Tajado'])),
        ...
        db.send_create_signal(u'Fabricacion', ['DetalleTajado'])

        # Adding model 'Tajado'
        db.create_table(u'Fabricacion_tajado', (
            ...
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('fechaTajado', self.gf('django.db.models.fields.DateField')()),
            ('pesoProducto', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3)),
            ('totalTajado', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloFilete', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Fabricacion', ['Tajado'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DetalleTajado'
        db.delete_table(u'Fabricacion_detalletajado')

        # Deleting model 'Tajado'
        db.delete_table(u'Fabricacion_tajado')
