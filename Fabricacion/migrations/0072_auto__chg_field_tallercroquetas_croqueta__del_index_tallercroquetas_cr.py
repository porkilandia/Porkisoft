...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'TallerCroquetas.croqueta' to match new field type.
        db.rename_column(u'Fabricacion_tallercroquetas', 'croqueta_id', 'croqueta')
        # Changing field 'TallerCroquetas.croqueta'
        db.alter_column(u'Fabricacion_tallercroquetas', 'croqueta', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))
        # Removing index on 'TallerCroquetas', fields ['croqueta']
        db.delete_index(u'Fabricacion_tallercroquetas', ['croqueta_id'])


    def backwards(self, orm):
        # Adding index on 'TallerCroquetas', fields ['croqueta']
        db.create_index(u'Fabricacion_tallercroquetas', ['croqueta_id'])


        # Renaming column for 'TallerCroquetas.croqueta' to match new field type.
        db.rename_column(u'Fabricacion_tallercroquetas', 'croqueta', 'croqueta_id')
        # Changing field 'TallerCroquetas.croqueta'
        db.alter_column(u'Fabricacion_tallercroquetas', 'croqueta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto']))
