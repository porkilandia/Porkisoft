...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condimentado.guardado'
        db.add_column(u'Fabricacion_condimentado', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condimentado.guardado'
        db.delete_column(u'Fabricacion_condimentado', 'guardado')
