...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DescarneCabeza.tipo'
        db.add_column(u'Fabricacion_descarnecabeza', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DescarneCabeza.tipo'
        db.delete_column(u'Fabricacion_descarnecabeza', 'tipo')
