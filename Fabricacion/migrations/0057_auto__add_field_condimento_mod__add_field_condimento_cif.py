...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condimento.mod'
        db.add_column(u'Fabricacion_condimento', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Condimento.cif'
        db.add_column(u'Fabricacion_condimento', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condimento.mod'
        db.delete_column(u'Fabricacion_condimento', 'mod')

        # Deleting field 'Condimento.cif'
        db.delete_column(u'Fabricacion_condimento', 'cif')
