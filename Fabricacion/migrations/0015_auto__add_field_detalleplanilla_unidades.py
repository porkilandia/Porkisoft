...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.unidades'
        db.add_column(u'Fabricacion_detalleplanilla', 'unidades',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.unidades'
        db.delete_column(u'Fabricacion_detalleplanilla', 'unidades')
