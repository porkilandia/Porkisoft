...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Conversiones'
        db.create_table(u'Fabricacion_conversiones', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaConversion', self.gf('django.db.models.fields.DateField')()),
            ('pesoConversion', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('productoUno', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('productoDos', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('costoP1', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('costoP2', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('guardado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Fabricacion', ['Conversiones'])


    def backwards(self, orm):
        # Deleting model 'Conversiones'
        db.delete_table(u'Fabricacion_conversiones')
