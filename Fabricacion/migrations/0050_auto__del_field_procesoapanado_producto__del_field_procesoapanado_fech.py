...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProcesoApanado.producto'
        db.delete_column(u'Fabricacion_procesoapanado', 'producto_id')

        # Deleting field 'ProcesoApanado.fecha'
        db.delete_column(u'Fabricacion_procesoapanado', 'fecha')

        # Adding field 'ProcesoApanado.fechaApanado'
        db.add_column(u'Fabricacion_procesoapanado', 'fechaApanado',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 28, 0, 0)),
                      keep_default=False)

        # Adding field 'ProcesoApanado.productoApanado'
        db.add_column(u'Fabricacion_procesoapanado', 'productoApanado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProcesoApanado.producto'
        db.add_column(u'Fabricacion_procesoapanado', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Adding field 'ProcesoApanado.fecha'
        db.add_column(u'Fabricacion_procesoapanado', 'fecha',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 28, 0, 0)),
                      keep_default=False)

        # Deleting field 'ProcesoApanado.fechaApanado'
        db.delete_column(u'Fabricacion_procesoapanado', 'fechaApanado')

        # Deleting field 'ProcesoApanado.productoApanado'
        db.delete_column(u'Fabricacion_procesoapanado', 'productoApanado_id')
