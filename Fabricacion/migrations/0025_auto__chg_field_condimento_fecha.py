...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Condimento.fecha'
        db.alter_column(u'Fabricacion_condimento', 'fecha', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Condimento.fecha'
        db.alter_column(u'Fabricacion_condimento', 'fecha', self.gf('django.db.models.fields.DateField')(auto_now=True))
