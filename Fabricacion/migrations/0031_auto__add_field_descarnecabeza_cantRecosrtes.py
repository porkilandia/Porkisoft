...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DescarneCabeza.cantRecosrtes'
        db.add_column(u'Fabricacion_descarnecabeza', 'cantRecosrtes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DescarneCabeza.cantRecosrtes'
        db.delete_column(u'Fabricacion_descarnecabeza', 'cantRecosrtes')
