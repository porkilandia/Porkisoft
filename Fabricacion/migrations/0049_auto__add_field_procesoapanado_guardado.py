...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcesoApanado.guardado'
        db.add_column(u'Fabricacion_procesoapanado', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcesoApanado.guardado'
        db.delete_column(u'Fabricacion_procesoapanado', 'guardado')
