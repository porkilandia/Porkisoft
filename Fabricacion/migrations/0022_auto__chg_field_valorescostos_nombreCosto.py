...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValoresCostos.nombreCosto'
        db.alter_column(u'Fabricacion_valorescostos', 'nombreCosto', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'ValoresCostos.nombreCosto'
        db.alter_column(u'Fabricacion_valorescostos', 'nombreCosto', self.gf('django.db.models.fields.CharField')(max_length=20))
