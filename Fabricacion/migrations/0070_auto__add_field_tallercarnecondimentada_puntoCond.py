...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerCarneCondimentada.puntoCond'
        db.add_column(u'Fabricacion_tallercarnecondimentada', 'puntoCond',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Bodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerCarneCondimentada.puntoCond'
        db.delete_column(u'Fabricacion_tallercarnecondimentada', 'puntoCond_id')
