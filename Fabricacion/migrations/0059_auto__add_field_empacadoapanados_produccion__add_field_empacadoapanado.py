...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmpacadoApanados.produccion'
        db.add_column(u'Fabricacion_empacadoapanados', 'produccion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Fabricacion.ProcesoApanado'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmpacadoApanados.costoKiloChuleta'
        db.add_column(u'Fabricacion_empacadoapanados', 'costoKiloChuleta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmpacadoApanados.produccion'
        db.delete_column(u'Fabricacion_empacadoapanados', 'produccion_id')

        # Deleting field 'EmpacadoApanados.costoKiloChuleta'
        db.delete_column(u'Fabricacion_empacadoapanados', 'costoKiloChuleta')
