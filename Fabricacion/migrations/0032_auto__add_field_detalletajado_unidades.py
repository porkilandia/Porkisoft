...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleTajado.unidades'
        db.add_column(u'Fabricacion_detalletajado', 'unidades',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleTajado.unidades'
        db.delete_column(u'Fabricacion_detalletajado', 'unidades')
