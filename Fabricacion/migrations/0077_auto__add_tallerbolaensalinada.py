...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerBolaEnsalinada'
        db.create_table(u'Fabricacion_tallerbolaensalinada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaBolaCondimentada', self.gf('django.db.models.fields.DateField')()),
            ('pesoBola', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('sal', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('papaina', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('pesoTotal', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloEns', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('guardado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Fabricacion', ['TallerBolaEnsalinada'])


    def backwards(self, orm):
        # Deleting model 'TallerBolaEnsalinada'
        db.delete_table(u'Fabricacion_tallerbolaensalinada')
