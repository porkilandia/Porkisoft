...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValoresCostos.valorKiloPie'
        db.add_column(u'Fabricacion_valorescostos', 'valorKiloPie',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ValoresCostos.valorKiloPie'
        db.delete_column(u'Fabricacion_valorescostos', 'valorKiloPie')
