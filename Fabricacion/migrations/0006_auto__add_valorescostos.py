...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ValoresCostos'
        db.create_table(u'Fabricacion_valorescostos', (
            ('codigoCosto', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombreCosto', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.send_create_signal(u'Fabricacion', ['ValoresCostos'])


    def backwards(self, orm):
        # Deleting model 'ValoresCostos'
        db.delete_table(u'Fabricacion_valorescostos')
