...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tajado.cif'
        db.add_column(u'Fabricacion_tajado', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Tajado.mod'
        db.add_column(u'Fabricacion_tajado', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tajado.cif'
        db.delete_column(u'Fabricacion_tajado', 'cif')

        # Deleting field 'Tajado.mod'
        db.delete_column(u'Fabricacion_tajado', 'mod')
