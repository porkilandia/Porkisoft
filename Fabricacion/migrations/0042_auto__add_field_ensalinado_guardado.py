...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ensalinado.guardado'
        db.add_column(u'Fabricacion_ensalinado', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ensalinado.guardado'
        db.delete_column(u'Fabricacion_ensalinado', 'guardado')
