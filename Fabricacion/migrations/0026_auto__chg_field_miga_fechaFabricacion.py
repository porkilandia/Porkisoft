...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Miga.fechaFabricacion'
        db.alter_column(u'Fabricacion_miga', 'fechaFabricacion', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Miga.fechaFabricacion'
        db.alter_column(u'Fabricacion_miga', 'fechaFabricacion', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'Fabricacion.miga': {
            ...
            'fechaFabricacion': ('django.db.models.fields.DateTimeField', [], {})
        },
