...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValoresCostos.valorMod'
        db.alter_column(u'Fabricacion_valorescostos', 'valorMod', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'ValoresCostos.valorMod'
        db.alter_column(u'Fabricacion_valorescostos', 'valorMod', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'Fabricacion.limpiezaverduras': {
            ...
            'fechaLimpieza': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)'}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
