...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerChicharron.productoCh'
        db.add_column(u'Fabricacion_tallerchicharron', 'productoCh',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerChicharron.productoCh'
        db.delete_column(u'Fabricacion_tallerchicharron', 'productoCh_id')
