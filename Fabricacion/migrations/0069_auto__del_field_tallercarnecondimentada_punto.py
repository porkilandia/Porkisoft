...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TallerCarneCondimentada.punto'
        db.delete_column(u'Fabricacion_tallercarnecondimentada', 'punto_id')


    def backwards(self, orm):
        # Adding field 'TallerCarneCondimentada.punto'
        db.add_column(u'Fabricacion_tallercarnecondimentada', 'punto',
