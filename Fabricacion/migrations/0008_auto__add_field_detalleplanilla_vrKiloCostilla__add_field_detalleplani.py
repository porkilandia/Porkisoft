...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.vrKiloCostilla'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloCostilla',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.pesoCostilla'
        db.add_column(u'Fabricacion_detalleplanilla', 'pesoCostilla',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.vrKiloCostilla'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloCostilla')

        # Deleting field 'DetallePlanilla.pesoCostilla'
        db.delete_column(u'Fabricacion_detalleplanilla', 'pesoCostilla')
