...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Menudos'
        db.create_table(u'Fabricacion_menudos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaMenudo', self.gf('django.db.models.fields.DateField')()),
            ('cantMenudos', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoMenudo', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('costoEscaldado', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('pesoPicadillo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloPicadillo', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'Fabricacion', ['Menudos'])


    def backwards(self, orm):
        # Deleting model 'Menudos'
        db.delete_table(u'Fabricacion_menudos')
