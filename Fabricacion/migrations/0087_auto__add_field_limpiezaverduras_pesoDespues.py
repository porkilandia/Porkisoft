...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LimpiezaVerduras.pesoDespues'
        db.add_column(u'Fabricacion_limpiezaverduras', 'pesoDespues',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LimpiezaVerduras.pesoDespues'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'pesoDespues')
