...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ValoresCostos.finaliza'
        db.delete_column(u'Fabricacion_valorescostos', 'finaliza')

        # Deleting field 'ValoresCostos.actual'
        db.delete_column(u'Fabricacion_valorescostos', 'actual')

        # Deleting field 'ValoresCostos.jornada'
        db.delete_column(u'Fabricacion_valorescostos', 'jornada')

        # Deleting field 'ValoresCostos.empleado'
        db.delete_column(u'Fabricacion_valorescostos', 'empleado_id')

        # Deleting field 'ValoresCostos.inicia'
        db.delete_column(u'Fabricacion_valorescostos', 'inicia')


    def backwards(self, orm):
        # Adding field 'ValoresCostos.finaliza'
        db.add_column(u'Fabricacion_valorescostos', 'finaliza',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ValoresCostos.actual'
        db.add_column(u'Fabricacion_valorescostos', 'actual',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ValoresCostos.jornada'
        db.add_column(u'Fabricacion_valorescostos', 'jornada',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ValoresCostos.empleado'
        db.add_column(u'Fabricacion_valorescostos', 'empleado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Nomina.Empleado']),
                      keep_default=False)

        # Adding field 'ValoresCostos.inicia'
        db.add_column(u'Fabricacion_valorescostos', 'inicia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
