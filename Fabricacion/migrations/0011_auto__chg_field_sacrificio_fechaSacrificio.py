...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Fabricacion_sacrificio', 'fechaSacrificio', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Sacrificio.fechaSacrificio'
        db.alter_column(u'Fabricacion_sacrificio', 'fechaSacrificio', self.gf('django.db.models.fields.DateField')(default=0))
