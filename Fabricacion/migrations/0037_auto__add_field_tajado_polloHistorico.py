...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tajado.polloHistorico'
        db.add_column(u'Fabricacion_tajado', 'polloHistorico',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Compra'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tajado.polloHistorico'
        db.delete_column(u'Fabricacion_tajado', 'polloHistorico_id')
