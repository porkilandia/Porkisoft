...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.vrKiloCarnes3'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes3',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.vrKiloCarnes4'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.vrKiloCarnes3'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes3')

        # Deleting field 'DetallePlanilla.vrKiloCarnes4'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes4')
