...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sacrificio.fechaSacrificio'
        db.alter_column(u'Fabricacion_sacrificio', 'fechaSacrificio', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Sacrificio.fechaSacrificio'
        db.alter_column(u'Fabricacion_sacrificio', 'fechaSacrificio', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        u'Fabricacion.sacrificio': {
            ...
            'fechaSacrificio': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
