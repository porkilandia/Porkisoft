...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.vrKiloCarnes2'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.vrKiloCarnes2'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes2')
