...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanillaDesposte.fechaDesposte'
        db.alter_column(u'Fabricacion_planilladesposte', 'fechaDesposte', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'PlanillaDesposte.fechaDesposte'
        db.alter_column(u'Fabricacion_planilladesposte', 'fechaDesposte', self.gf('django.db.models.fields.DateField')(auto_now=True))
