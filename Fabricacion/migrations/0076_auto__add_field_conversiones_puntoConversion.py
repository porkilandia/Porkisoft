...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversiones.puntoConversion'
        db.add_column(u'Fabricacion_conversiones', 'puntoConversion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Bodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversiones.puntoConversion'
        db.delete_column(u'Fabricacion_conversiones', 'puntoConversion_id')
