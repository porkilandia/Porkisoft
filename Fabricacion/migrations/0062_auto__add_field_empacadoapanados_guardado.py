...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmpacadoApanados.guardado'
        db.add_column(u'Fabricacion_empacadoapanados', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmpacadoApanados.guardado'
        db.delete_column(u'Fabricacion_empacadoapanados', 'guardado')
