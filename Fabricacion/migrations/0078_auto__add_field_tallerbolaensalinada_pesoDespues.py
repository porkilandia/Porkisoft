...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerBolaEnsalinada.pesoDespues'
        db.add_column(u'Fabricacion_tallerbolaensalinada', 'pesoDespues',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerBolaEnsalinada.pesoDespues'
        db.delete_column(u'Fabricacion_tallerbolaensalinada', 'pesoDespues')
