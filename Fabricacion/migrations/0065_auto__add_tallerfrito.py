...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerFrito'
        db.create_table(u'Fabricacion_tallerfrito', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaFrito', self.gf('django.db.models.fields.DateField')()),
            ('productoFrito', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ...
            ('pesoTotalFrito', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloFrito', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Fabricacion', ['TallerFrito'])


    def backwards(self, orm):
        # Deleting model 'TallerFrito'
        db.delete_table(u'Fabricacion_tallerfrito')
