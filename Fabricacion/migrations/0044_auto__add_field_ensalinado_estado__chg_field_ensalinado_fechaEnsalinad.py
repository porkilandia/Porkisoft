...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ensalinado.estado'
        db.add_column(u'Fabricacion_ensalinado', 'estado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Ensalinado.fechaEnsalinado'
        db.alter_column(u'Fabricacion_ensalinado', 'fechaEnsalinado', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Ensalinado.estado'
        db.delete_column(u'Fabricacion_ensalinado', 'estado')


        # Changing field 'Ensalinado.fechaEnsalinado'
        db.alter_column(u'Fabricacion_ensalinado', 'fechaEnsalinado', self.gf('django.db.models.fields.DateField')(auto_now=True))
