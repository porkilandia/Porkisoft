...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condimentado.resPollo'
        db.add_column(u'Fabricacion_condimentado', 'resPollo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Adding field 'Condimentado.saborLonganiza'
        db.add_column(u'Fabricacion_condimentado', 'saborLonganiza',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Adding field 'Condimentado.ablandaCarnes'
        db.add_column(u'Fabricacion_condimentado', 'ablandaCarnes',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condimentado.resPollo'
        db.delete_column(u'Fabricacion_condimentado', 'resPollo')

        # Deleting field 'Condimentado.saborLonganiza'
        db.delete_column(u'Fabricacion_condimentado', 'saborLonganiza')

        # Deleting field 'Condimentado.ablandaCarnes'
        db.delete_column(u'Fabricacion_condimentado', 'ablandaCarnes')
