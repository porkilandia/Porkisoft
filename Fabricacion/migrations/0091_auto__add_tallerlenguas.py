...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerLenguas'
        db.create_table(u'Fabricacion_tallerlenguas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaLenguas', self.gf('django.db.models.fields.DateField')()),
            ('pesoAntes', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('pesoDespues', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
        ...
        db.send_create_signal(u'Fabricacion', ['TallerLenguas'])


    def backwards(self, orm):
        # Deleting model 'TallerLenguas'
        db.delete_table(u'Fabricacion_tallerlenguas')
    ...
    models = {
        ...
        u'Fabricacion.limpiezaverduras': {
            ...
            'fechaLimpieza': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 19, 0, 0)'}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
