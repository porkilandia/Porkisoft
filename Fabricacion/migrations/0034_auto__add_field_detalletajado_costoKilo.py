...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleTajado.costoKilo'
        db.add_column(u'Fabricacion_detalletajado', 'costoKilo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleTajado.costoKilo'
        db.delete_column(u'Fabricacion_detalletajado', 'costoKilo')
