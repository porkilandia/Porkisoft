...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleCondimento.producto'
        db.delete_column(u'Fabricacion_detallecondimento', 'producto_id')

        # Adding field 'DetalleCondimento.productoCondimento'
        db.add_column(u'Fabricacion_detallecondimento', 'productoCondimento',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetalleCondimento.producto'
        db.add_column(u'Fabricacion_detallecondimento', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Deleting field 'DetalleCondimento.productoCondimento'
        db.delete_column(u'Fabricacion_detallecondimento', 'productoCondimento_id')
