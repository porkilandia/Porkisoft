...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerFrito.punto'
        db.add_column(u'Fabricacion_tallerfrito', 'punto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Bodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerFrito.punto'
        db.delete_column(u'Fabricacion_tallerfrito', 'punto_id')
