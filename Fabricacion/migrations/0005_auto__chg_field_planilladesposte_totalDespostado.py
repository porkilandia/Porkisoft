...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanillaDesposte.totalDespostado'
        db.alter_column(u'Fabricacion_planilladesposte', 'totalDespostado', self.gf('django.db.models.fields.DecimalField')(max_digits=13, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'PlanillaDesposte.totalDespostado'
        db.alter_column(u'Fabricacion_planilladesposte', 'totalDespostado', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))
