...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Miga.guardado'
        db.add_column(u'Fabricacion_miga', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Miga.guardado'
        db.delete_column(u'Fabricacion_miga', 'guardado')
    ...
    models = {
        ...
        u'Fabricacion.limpiezaverduras': {
            ...
            'fechaLimpieza': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
