...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condimentado.mod'
        db.add_column(u'Fabricacion_condimentado', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Condimentado.cif'
        db.add_column(u'Fabricacion_condimentado', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condimentado.mod'
        db.delete_column(u'Fabricacion_condimentado', 'mod')

        # Deleting field 'Condimentado.cif'
        db.delete_column(u'Fabricacion_condimentado', 'cif')
