...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'auxiliarPromedios'
        db.create_table(u'Fabricacion_auxiliarpromedios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombreProducto', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('costo', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'Fabricacion', ['auxiliarPromedios'])


    def backwards(self, orm):
        # Deleting model 'auxiliarPromedios'
        db.delete_table(u'Fabricacion_auxiliarpromedios')
