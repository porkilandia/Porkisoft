...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.costoAdtvo'
        db.add_column(u'Fabricacion_detalleplanilla', 'costoAdtvo',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.costoAdtvo'
        db.delete_column(u'Fabricacion_detalleplanilla', 'costoAdtvo')
