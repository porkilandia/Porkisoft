...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tajado.desposteHistorico'
        db.add_column(u'Fabricacion_tajado', 'desposteHistorico',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Fabricacion.PlanillaDesposte'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tajado.desposteHistorico'
        db.delete_column(u'Fabricacion_tajado', 'desposteHistorico_id')
