...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Condimentado.fecha'
        db.alter_column(u'Fabricacion_condimentado', 'fecha', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Condimentado.fecha'
        db.alter_column(u'Fabricacion_condimentado', 'fecha', self.gf('django.db.models.fields.DateField')(auto_now=True))
