...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleMiga.producto'
        db.delete_column(u'Fabricacion_detallemiga', 'producto_id')

        # Adding field 'DetalleMiga.productoMiga'
        db.add_column(u'Fabricacion_detallemiga', 'productoMiga',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetalleMiga.producto'
        db.add_column(u'Fabricacion_detallemiga', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Deleting field 'DetalleMiga.productoMiga'
        db.delete_column(u'Fabricacion_detallemiga', 'productoMiga_id')
