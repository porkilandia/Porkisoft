...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DescarneCabeza.guardado'
        db.add_column(u'Fabricacion_descarnecabeza', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DescarneCabeza.guardado'
        db.delete_column(u'Fabricacion_descarnecabeza', 'guardado')
