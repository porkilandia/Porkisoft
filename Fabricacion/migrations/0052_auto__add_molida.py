...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Molida'
        db.create_table(u'Fabricacion_molida', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaMolido', self.gf('django.db.models.fields.DateField')()),
            ('pesoAmoler', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('productoMolido', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ...
            ('totalMolido', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloMolido', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Fabricacion', ['Molida'])


    def backwards(self, orm):
        # Deleting model 'Molida'
        db.delete_table(u'Fabricacion_molida')
