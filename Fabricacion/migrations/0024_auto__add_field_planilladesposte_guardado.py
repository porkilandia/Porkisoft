...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanillaDesposte.guardado'
        db.add_column(u'Fabricacion_planilladesposte', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanillaDesposte.guardado'
        db.delete_column(u'Fabricacion_planilladesposte', 'guardado')
