...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Fabricacion_condimentado', (
            ...
            ('pesoACondimentar', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('condimento', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoFilete', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('costoCondimento', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('pesoFileteCond', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoFileteCond', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
