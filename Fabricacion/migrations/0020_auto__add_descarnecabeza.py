...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DescarneCabeza'
        db.create_table(u'Fabricacion_descarnecabeza', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')()),
            ('recortes', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('caretas', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('lenguas', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ...
            ('vrKiloRecorte', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('vrKiloLengua', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('vrKiloCareta', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('vrKiloProceso', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Fabricacion', ['DescarneCabeza'])


    def backwards(self, orm):
        # Deleting model 'DescarneCabeza'
        db.delete_table(u'Fabricacion_descarnecabeza')
