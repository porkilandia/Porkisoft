...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LimpiezaVerduras.producto'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'producto_id')

        # Adding field 'LimpiezaVerduras.productoLimpiar'
        db.add_column(u'Fabricacion_limpiezaverduras', 'productoLimpiar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Adding field 'LimpiezaVerduras.valorProducto'
        db.add_column(u'Fabricacion_limpiezaverduras', 'valorProducto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LimpiezaVerduras.valorTransporte'
        db.add_column(u'Fabricacion_limpiezaverduras', 'valorTransporte',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LimpiezaVerduras.guardado'
        db.add_column(u'Fabricacion_limpiezaverduras', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'LimpiezaVerduras.compra'
        db.alter_column(u'Fabricacion_limpiezaverduras', 'compra_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Compra']))

    def backwards(self, orm):
        # Adding field 'LimpiezaVerduras.producto'
        db.add_column(u'Fabricacion_limpiezaverduras', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Deleting field 'LimpiezaVerduras.productoLimpiar'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'productoLimpiar_id')

        # Deleting field 'LimpiezaVerduras.valorProducto'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'valorProducto')

        # Deleting field 'LimpiezaVerduras.valorTransporte'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'valorTransporte')

        # Deleting field 'LimpiezaVerduras.guardado'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'guardado')


        # Changing field 'LimpiezaVerduras.compra'
        db.alter_column(u'Fabricacion_limpiezaverduras', 'compra_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.DetalleCompra']))
