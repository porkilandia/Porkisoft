...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TallerCroquetas.pesoCroqueta'
        db.delete_column(u'Fabricacion_tallercroquetas', 'pesoCroqueta')


    def backwards(self, orm):
        # Adding field 'TallerCroquetas.pesoCroqueta'
        db.add_column(u'Fabricacion_tallercroquetas', 'pesoCroqueta',
