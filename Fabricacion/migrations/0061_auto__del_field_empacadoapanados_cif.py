...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmpacadoApanados.cif'
        db.delete_column(u'Fabricacion_empacadoapanados', 'cif')


    def backwards(self, orm):
        # Adding field 'EmpacadoApanados.cif'
        db.add_column(u'Fabricacion_empacadoapanados', 'cif',
