...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ValoresCostos.valor'
        db.delete_column(u'Fabricacion_valorescostos', 'valor')

        # Adding field 'ValoresCostos.valorCif'
        db.add_column(u'Fabricacion_valorescostos', 'valorCif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ValoresCostos.valorMod'
        db.add_column(u'Fabricacion_valorescostos', 'valorMod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ValoresCostos.valor'
        db.add_column(u'Fabricacion_valorescostos', 'valor',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ValoresCostos.valorCif'
        db.delete_column(u'Fabricacion_valorescostos', 'valorCif')

        # Deleting field 'ValoresCostos.valorMod'
        db.delete_column(u'Fabricacion_valorescostos', 'valorMod')
