...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanillaDesposte.tipoDesposte'
        db.add_column(u'Fabricacion_planilladesposte', 'tipoDesposte',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanillaDesposte.tipoDesposte'
        db.delete_column(u'Fabricacion_planilladesposte', 'tipoDesposte')
