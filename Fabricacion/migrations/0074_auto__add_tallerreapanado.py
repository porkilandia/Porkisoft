...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerReapanado'
        db.create_table(u'Fabricacion_tallerreapanado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaReApanado', self.gf('django.db.models.fields.DateField')()),
            ('pesoChuleta', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('miga', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('chuelta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('puntoReApanado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Bodega'])),
            ('pesoTotalReApanado', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('guardado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Fabricacion', ['TallerReapanado'])


    def backwards(self, orm):
        # Deleting model 'TallerReapanado'
        db.delete_table(u'Fabricacion_tallerreapanado')
