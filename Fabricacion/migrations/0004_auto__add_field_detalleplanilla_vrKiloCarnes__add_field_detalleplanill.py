...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetallePlanilla.vrKiloCarnes'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.vrKiloHuesos'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloHuesos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.vrKiloSubProd'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloSubProd',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.vrKiloDesecho'
        db.add_column(u'Fabricacion_detalleplanilla', 'vrKiloDesecho',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetallePlanilla.pesoCarne'
        db.add_column(u'Fabricacion_detalleplanilla', 'pesoCarne',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=3),
                      keep_default=False)

        # Adding field 'DetallePlanilla.pesoHueso'
        db.add_column(u'Fabricacion_detalleplanilla', 'pesoHueso',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=3),
                      keep_default=False)

        # Adding field 'DetallePlanilla.pesoSubProd'
        db.add_column(u'Fabricacion_detalleplanilla', 'pesoSubProd',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=3),
                      keep_default=False)

        # Adding field 'DetallePlanilla.pesoDesecho'
        db.add_column(u'Fabricacion_detalleplanilla', 'pesoDesecho',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetallePlanilla.vrKiloCarnes'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloCarnes')

        # Deleting field 'DetallePlanilla.vrKiloHuesos'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloHuesos')

        # Deleting field 'DetallePlanilla.vrKiloSubProd'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloSubProd')

        # Deleting field 'DetallePlanilla.vrKiloDesecho'
        db.delete_column(u'Fabricacion_detalleplanilla', 'vrKiloDesecho')

        # Deleting field 'DetallePlanilla.pesoCarne'
        db.delete_column(u'Fabricacion_detalleplanilla', 'pesoCarne')

        # Deleting field 'DetallePlanilla.pesoHueso'
        db.delete_column(u'Fabricacion_detalleplanilla', 'pesoHueso')

        # Deleting field 'DetallePlanilla.pesoSubProd'
        db.delete_column(u'Fabricacion_detalleplanilla', 'pesoSubProd')

        # Deleting field 'DetallePlanilla.pesoDesecho'
        db.delete_column(u'Fabricacion_detalleplanilla', 'pesoDesecho')
