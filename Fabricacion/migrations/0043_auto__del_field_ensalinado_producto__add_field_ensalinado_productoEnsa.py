...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ensalinado.producto'
        db.delete_column(u'Fabricacion_ensalinado', 'producto_id')

        # Adding field 'Ensalinado.productoEnsalinado'
        db.add_column(u'Fabricacion_ensalinado', 'productoEnsalinado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ensalinado.producto'
        db.add_column(u'Fabricacion_ensalinado', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.Producto']),
                      keep_default=False)

        # Deleting field 'Ensalinado.productoEnsalinado'
        db.delete_column(u'Fabricacion_ensalinado', 'productoEnsalinado_id')
    ...
    models = {
        ...
        u'Fabricacion.ensalinado': {
            ...
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
