...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerBolaEnsalinada.puntoBodega'
        db.add_column(u'Fabricacion_tallerbolaensalinada', 'puntoBodega',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Inventario.ProductoBodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerBolaEnsalinada.puntoBodega'
        db.delete_column(u'Fabricacion_tallerbolaensalinada', 'puntoBodega_id')
    ...
    models = {
        ...
        u'Fabricacion.tallerbolaensalinada': {
            ...
            'puntoBodega': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Inventario.ProductoBodega']"}),
