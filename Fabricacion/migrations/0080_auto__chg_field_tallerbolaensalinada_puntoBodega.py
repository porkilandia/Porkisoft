...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TallerBolaEnsalinada.puntoBodega'
        db.alter_column(u'Fabricacion_tallerbolaensalinada', 'puntoBodega_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Bodega']))

    def backwards(self, orm):

        # Changing field 'TallerBolaEnsalinada.puntoBodega'
        db.alter_column(u'Fabricacion_tallerbolaensalinada', 'puntoBodega_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.ProductoBodega']))
