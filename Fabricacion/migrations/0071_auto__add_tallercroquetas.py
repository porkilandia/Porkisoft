...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerCroquetas'
        db.create_table(u'Fabricacion_tallercroquetas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaCroqueta', self.gf('django.db.models.fields.DateField')()),
            ('pesoCroqueta', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ...
            ('puntoCroq', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Bodega'])),
            ('croqueta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('pesoTotalCroqueta', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoKiloCroqueta', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('guardado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Fabricacion', ['TallerCroquetas'])


    def backwards(self, orm):
        # Deleting model 'TallerCroquetas'
        db.delete_table(u'Fabricacion_tallercroquetas')
    ...
    models = {
        ...
        u'Fabricacion.tallercroquetas': {
            ...
            'croqueta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Inventario.Producto']"}),
            'fechaCroqueta': ('django.db.models.fields.DateField', [], {}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'miga': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '3'}),
            'pesoCroqueta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '3'}),
