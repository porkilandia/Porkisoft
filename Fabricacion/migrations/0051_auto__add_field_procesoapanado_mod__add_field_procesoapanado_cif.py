...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcesoApanado.mod'
        db.add_column(u'Fabricacion_procesoapanado', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProcesoApanado.cif'
        db.add_column(u'Fabricacion_procesoapanado', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcesoApanado.mod'
        db.delete_column(u'Fabricacion_procesoapanado', 'mod')

        # Deleting field 'ProcesoApanado.cif'
        db.delete_column(u'Fabricacion_procesoapanado', 'cif')
