...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmpacadoApanados'
        db.create_table(u'Fabricacion_empacadoapanados', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaEmpacado', self.gf('django.db.models.fields.DateField')()),
            ('productoAEmpacar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('cantBandejas', self.gf('django.db.models.fields.IntegerField')()),
            ('stikers', self.gf('django.db.models.fields.IntegerField')()),
            ('costobandeja', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('pesoBandeja', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('mod', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('cif', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Fabricacion', ['EmpacadoApanados'])


    def backwards(self, orm):
        # Deleting model 'EmpacadoApanados'
        db.delete_table(u'Fabricacion_empacadoapanados')
