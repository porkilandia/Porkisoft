...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TallerChicharron'
        db.create_table(u'Fabricacion_tallerchicharron', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaChicharron', self.gf('django.db.models.fields.DateField')()),
            ('Tocino', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('Sal', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('undGrasa', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('undChicharron', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('chicharron', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('grasa', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=3)),
            ('costoUndChicharron', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('costoUndGrasa', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mod', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('cif', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('guardado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Fabricacion', ['TallerChicharron'])


    def backwards(self, orm):
        # Deleting model 'TallerChicharron'
        db.delete_table(u'Fabricacion_tallerchicharron')
