...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Miga.mod'
        db.add_column(u'Fabricacion_miga', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Miga.cif'
        db.add_column(u'Fabricacion_miga', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Miga.mod'
        db.delete_column(u'Fabricacion_miga', 'mod')

        # Deleting field 'Miga.cif'
        db.delete_column(u'Fabricacion_miga', 'cif')
