...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LimpiezaVerduras.fechaLimpieza'
        db.add_column(u'Fabricacion_limpiezaverduras', 'fechaLimpieza',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 1, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LimpiezaVerduras.fechaLimpieza'
        db.delete_column(u'Fabricacion_limpiezaverduras', 'fechaLimpieza')
    ...
    models = {
        ...
        u'Fabricacion.limpiezaverduras': {
            ...
            'fechaLimpieza': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)'}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
