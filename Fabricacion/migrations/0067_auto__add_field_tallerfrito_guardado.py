...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TallerFrito.guardado'
        db.add_column(u'Fabricacion_tallerfrito', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TallerFrito.guardado'
        db.delete_column(u'Fabricacion_tallerfrito', 'guardado')
