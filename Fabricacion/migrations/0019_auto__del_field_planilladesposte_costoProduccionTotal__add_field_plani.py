...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlanillaDesposte.costoProduccionTotal'
        db.delete_column(u'Fabricacion_planilladesposte', 'costoProduccionTotal')

        # Adding field 'PlanillaDesposte.cif'
        db.add_column(u'Fabricacion_planilladesposte', 'cif',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlanillaDesposte.mod'
        db.add_column(u'Fabricacion_planilladesposte', 'mod',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PlanillaDesposte.costoProduccionTotal'
        db.add_column(u'Fabricacion_planilladesposte', 'costoProduccionTotal',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PlanillaDesposte.cif'
        db.delete_column(u'Fabricacion_planilladesposte', 'cif')

        # Deleting field 'PlanillaDesposte.mod'
        db.delete_column(u'Fabricacion_planilladesposte', 'mod')
