...
class Condimentado(models.Model):
    ...
    resPollo = models.DecimalField(verbose_name='Resaltador Pollo', max_digits=9, decimal_places=3,default=0)
    saborLonganiza = models.DecimalField(verbose_name='Sabor Longaniza', max_digits=9, decimal_places=3,default=0)
    ablandaCarnes = models.DecimalField(verbose_name='Ablanda carne', max_digits=9, decimal_places=3,default=0)
