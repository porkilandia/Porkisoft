...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pedido.fechaPedido'
        db.alter_column(u'Ventas_pedido', 'fechaPedido', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Pedido.fechaPedido'
        db.alter_column(u'Ventas_pedido', 'fechaPedido', self.gf('django.db.models.fields.DateTimeField')())
