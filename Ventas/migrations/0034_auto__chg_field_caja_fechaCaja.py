...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caja.fechaCaja'
        db.alter_column(u'Ventas_caja', 'fechaCaja', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Caja.fechaCaja'
        db.alter_column(u'Ventas_caja', 'fechaCaja', self.gf('django.db.models.fields.DateField')(auto_now=True))
