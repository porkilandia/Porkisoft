...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pedido.numeroFactura'
        db.add_column(u'Ventas_pedido', 'numeroFactura',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pedido.numeroFactura'
        db.delete_column(u'Ventas_pedido', 'numeroFactura')
