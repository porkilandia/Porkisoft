...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Devolucion'
        db.create_table(u'Ventas_devolucion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechaDevolucion', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('encargado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Nomina.Empleado'])),
            ('productoDev', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
        ...
        db.send_create_signal(u'Ventas', ['Devolucion'])

        # Adding model 'DetalleDevolucion'
        db.create_table(u'Ventas_detalledevolucion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('devolucion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Ventas.Devolucion'])),
            ('productoDev', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('pesoProducto', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3)),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Ventas', ['DetalleDevolucion'])

        # Adding field 'Retiros.guardado'
        db.add_column(u'Ventas_retiros', 'guardado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Devolucion'
        db.delete_table(u'Ventas_devolucion')

        # Deleting model 'DetalleDevolucion'
        db.delete_table(u'Ventas_detalledevolucion')

        # Deleting field 'Retiros.guardado'
        db.delete_column(u'Ventas_retiros', 'guardado')
