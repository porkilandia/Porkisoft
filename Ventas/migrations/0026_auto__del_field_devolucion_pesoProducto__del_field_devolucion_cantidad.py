...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Devolucion.pesoProducto'
        db.delete_column(u'Ventas_devolucion', 'pesoProducto')

        # Deleting field 'Devolucion.cantidad'
        db.delete_column(u'Ventas_devolucion', 'cantidad')

        # Deleting field 'Devolucion.productoDev'
        db.delete_column(u'Ventas_devolucion', 'productoDev_id')


    def backwards(self, orm):
        # Adding field 'Devolucion.pesoProducto'
        db.add_column(u'Ventas_devolucion', 'pesoProducto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Adding field 'Devolucion.cantidad'
        db.add_column(u'Ventas_devolucion', 'cantidad',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Devolucion.productoDev'
        db.add_column(u'Ventas_devolucion', 'productoDev',
