...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetalleVentaPunto.venta'
        db.alter_column(u'Ventas_detalleventapunto', 'venta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Ventas.VentaPunto']))

    def backwards(self, orm):

        # Changing field 'DetalleVentaPunto.venta'
        db.alter_column(u'Ventas_detalleventapunto', 'venta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Ventas.Venta']))
