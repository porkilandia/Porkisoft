...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VentaPunto.fechaVenta'
        db.alter_column(u'Ventas_ventapunto', 'fechaVenta', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'VentaPunto.fechaVenta'
        db.alter_column(u'Ventas_ventapunto', 'fechaVenta', self.gf('django.db.models.fields.DateField')(auto_now=True))
