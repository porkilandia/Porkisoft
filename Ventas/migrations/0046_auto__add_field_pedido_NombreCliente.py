...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pedido.NombreCliente'
        db.add_column(u'Ventas_pedido', 'NombreCliente',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pedido.NombreCliente'
        db.delete_column(u'Ventas_pedido', 'NombreCliente')
