...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListaDePrecios.tipoLista'
        db.add_column(u'Ventas_listadeprecios', 'tipoLista',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=5),
                      keep_default=False)

        # Adding field 'ListaDePrecios.bodega'
        db.add_column(u'Ventas_listadeprecios', 'bodega',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Inventario.Bodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListaDePrecios.tipoLista'
        db.delete_column(u'Ventas_listadeprecios', 'tipoLista')

        # Deleting field 'ListaDePrecios.bodega'
        db.delete_column(u'Ventas_listadeprecios', 'bodega_id')
    ...
    models = {
        ...
        u'Ventas.listadeprecios': {
            ...
            'tipoLista': ('django.db.models.fields.CharField', [], {'max_length': '5'})
        },
        u'Ventas.pedido': {
