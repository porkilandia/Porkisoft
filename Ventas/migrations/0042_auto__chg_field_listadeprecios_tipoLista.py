...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListaDePrecios.tipoLista'
        db.alter_column(u'Ventas_listadeprecios', 'tipoLista', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'ListaDePrecios.tipoLista'
        db.alter_column(u'Ventas_listadeprecios', 'tipoLista', self.gf('django.db.models.fields.CharField')(max_length=5))
