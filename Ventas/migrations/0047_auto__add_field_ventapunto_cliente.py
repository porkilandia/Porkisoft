...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VentaPunto.cliente'
        db.add_column(u'Ventas_ventapunto', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Telemercadeo.Cliente'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VentaPunto.cliente'
        db.delete_column(u'Ventas_ventapunto', 'cliente_id')
    ...
    models = {
        ...
        u'Ventas.ventapunto': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Telemercadeo.Cliente']", 'null': 'True'}),
            'encargado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Nomina.Empleado']"}),
