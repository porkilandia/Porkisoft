...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListaDePrecios'
        db.create_table(u'Ventas_listadeprecios', (
            ('codigoLista', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('nombreLista', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'Ventas', ['ListaDePrecios'])

        # Adding model 'DetalleLista'
        db.create_table(u'Ventas_detallelista', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lista', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Ventas.ListaDePrecios'])),
            ('productoLista', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'])),
            ('costoKilo', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3)),
            ('precioVenta', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'Ventas', ['DetalleLista'])


    def backwards(self, orm):
        # Deleting model 'ListaDePrecios'
        db.delete_table(u'Ventas_listadeprecios')

        # Deleting model 'DetalleLista'
        db.delete_table(u'Ventas_detallelista')
