...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.TotalCredito'
        db.add_column(u'Ventas_venta', 'TotalCredito',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Venta.TotalContado'
        db.add_column(u'Ventas_venta', 'TotalContado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venta.TotalCredito'
        db.delete_column(u'Ventas_venta', 'TotalCredito')

        # Deleting field 'Venta.TotalContado'
        db.delete_column(u'Ventas_venta', 'TotalContado')
