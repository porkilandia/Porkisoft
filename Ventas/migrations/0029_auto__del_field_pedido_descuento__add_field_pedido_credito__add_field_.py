...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pedido.descuento'
        db.delete_column(u'Ventas_pedido', 'descuento')

        # Adding field 'Pedido.credito'
        db.add_column(u'Ventas_pedido', 'credito',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Pedido.contado'
        db.add_column(u'Ventas_pedido', 'contado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pedido.descuento'
        db.add_column(u'Ventas_pedido', 'descuento',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Pedido.credito'
        db.delete_column(u'Ventas_pedido', 'credito')

        # Deleting field 'Pedido.contado'
        db.delete_column(u'Ventas_pedido', 'contado')
