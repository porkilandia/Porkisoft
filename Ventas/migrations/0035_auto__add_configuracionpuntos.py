...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConfiguracionPuntos'
        db.create_table(u'Ventas_configuracionpuntos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('nombreConfiguracion', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cajero', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Nomina.Empleado'])),
            ('jornada', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('inicia', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('actual', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('finaliza', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('consecutivoZ', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Ventas', ['ConfiguracionPuntos'])


    def backwards(self, orm):
        # Deleting model 'ConfiguracionPuntos'
        db.delete_table(u'Ventas_configuracionpuntos')
