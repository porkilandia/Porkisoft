...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleVentaPunto.vrUnitario'
        db.delete_column(u'Ventas_detalleventapunto', 'vrUnitario')

        # Deleting field 'DetalleVentaPunto.vrTotal'
        db.delete_column(u'Ventas_detalleventapunto', 'vrTotal')

        # Adding field 'DetalleVentaPunto.vrUnitarioPunto'
        db.add_column(u'Ventas_detalleventapunto', 'vrUnitarioPunto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetalleVentaPunto.vrTotalPunto'
        db.add_column(u'Ventas_detalleventapunto', 'vrTotalPunto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetalleVentaPunto.vrUnitario'
        db.add_column(u'Ventas_detalleventapunto', 'vrUnitario',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DetalleVentaPunto.vrTotal'
        db.add_column(u'Ventas_detalleventapunto', 'vrTotal',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DetalleVentaPunto.vrUnitarioPunto'
        db.delete_column(u'Ventas_detalleventapunto', 'vrUnitarioPunto')

        # Deleting field 'DetalleVentaPunto.vrTotalPunto'
        db.delete_column(u'Ventas_detalleventapunto', 'vrTotalPunto')
