...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleVenta.producto'
        db.delete_column(u'Ventas_detalleventa', 'producto_id')

        # Deleting field 'DetalleVenta.cliente'
        db.delete_column(u'Ventas_detalleventa', 'cliente_id')

        # Adding field 'DetalleVenta.productoVenta'
        db.add_column(u'Ventas_detalleventa', 'productoVenta',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetalleVenta.producto'
        db.add_column(u'Ventas_detalleventa', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True),
                      keep_default=False)

        # Adding field 'DetalleVenta.cliente'
        db.add_column(u'Ventas_detalleventa', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Telemercadeo.Cliente'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DetalleVenta.productoVenta'
        db.delete_column(u'Ventas_detalleventa', 'productoVenta_id')
