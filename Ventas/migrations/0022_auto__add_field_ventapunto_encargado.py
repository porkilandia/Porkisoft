...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VentaPunto.encargado'
        db.add_column(u'Ventas_ventapunto', 'encargado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12345678, to=orm['Nomina.Empleado']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VentaPunto.encargado'
        db.delete_column(u'Ventas_ventapunto', 'encargado_id')
