...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'prueba'
        db.create_table(u'Ventas_prueba', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prueba', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'Ventas', ['prueba'])


    def backwards(self, orm):
        # Deleting model 'prueba'
        db.delete_table(u'Ventas_prueba')
