...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Caja.TotalRestaurante'
        db.add_column(u'Ventas_caja', 'TotalRestaurante',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Caja.TotalRestaurante'
        db.delete_column(u'Ventas_caja', 'TotalRestaurante')
