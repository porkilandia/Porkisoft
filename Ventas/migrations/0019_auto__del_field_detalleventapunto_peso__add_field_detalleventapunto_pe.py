...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleVentaPunto.peso'
        db.delete_column(u'Ventas_detalleventapunto', 'peso')

        # Adding field 'DetalleVentaPunto.pesoVentaPunto'
        db.add_column(u'Ventas_detalleventapunto', 'pesoVentaPunto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetalleVentaPunto.peso'
        db.add_column(u'Ventas_detalleventapunto', 'peso',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Deleting field 'DetalleVentaPunto.pesoVentaPunto'
        db.delete_column(u'Ventas_detalleventapunto', 'pesoVentaPunto')
