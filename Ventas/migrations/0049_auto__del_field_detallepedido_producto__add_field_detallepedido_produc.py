...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'Ventas_detallepedido', 'producto_id')

        # Adding field 'DetallePedido.productoPedido'
        db.add_column(u'Ventas_detallepedido', 'productoPedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetallePedido.producto'
        db.add_column(u'Ventas_detallepedido', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Inventario.Producto'], null=True),
                      keep_default=False)

        # Deleting field 'DetallePedido.productoPedido'
        db.delete_column(u'Ventas_detallepedido', 'productoPedido_id')
    ...
    models = {
        ...
        u'Ventas.detallepedido': {
            ...
            'productoPedido': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Inventario.Producto']", 'null': 'True', 'blank': 'True'}),
        ...
        u'Ventas.detalleventapunto': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pesoVentaPunto': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '3'}),
            'productoVenta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Inventario.Producto']", 'null': 'True', 'blank': 'True'}),
            'unidades': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        u'Ventas.listadeprecios': {
            ...
            'tipoLista': ('django.db.models.fields.CharField', [], {'max_length': '15'})
        },
        u'Ventas.pedido': {
            'Meta': {'object_name': 'Pedido'},
            'NombreCliente': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100'}),
            'TotalVenta': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'bodega': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Inventario.Bodega']"}),
            ...
            'fechaPedido': ('django.db.models.fields.DateField', [], {}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'listaPrecioPedido': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Ventas.ListaDePrecios']"}),
            'nitCliente': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '50'}),
        ...
        u'Ventas.prueba': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prueba': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        u'Ventas.retiros': {
        ...
        u'Ventas.ventapunto': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Telemercadeo.Cliente']", 'null': 'True', 'blank': 'True'}),
            'encargado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Nomina.Empleado']"}),
