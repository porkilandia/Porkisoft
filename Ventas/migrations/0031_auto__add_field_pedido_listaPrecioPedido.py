...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pedido.listaPrecioPedido'
        db.add_column(u'Ventas_pedido', 'listaPrecioPedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['Ventas.ListaDePrecios']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pedido.listaPrecioPedido'
        db.delete_column(u'Ventas_pedido', 'listaPrecioPedido_id')
