...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetallePedido.unidades'
        db.delete_column(u'Ventas_detallepedido', 'unidades')

        # Deleting field 'DetallePedido.peso'
        db.delete_column(u'Ventas_detallepedido', 'peso')

        # Adding field 'DetallePedido.pesoPedido'
        db.add_column(u'Ventas_detallepedido', 'pesoPedido',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Adding field 'DetallePedido.unidadesPedido'
        db.add_column(u'Ventas_detallepedido', 'unidadesPedido',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetallePedido.unidades'
        db.add_column(u'Ventas_detallepedido', 'unidades',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'DetallePedido.peso'
        db.add_column(u'Ventas_detallepedido', 'peso',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3),
                      keep_default=False)

        # Deleting field 'DetallePedido.pesoPedido'
        db.delete_column(u'Ventas_detallepedido', 'pesoPedido')

        # Deleting field 'DetallePedido.unidadesPedido'
        db.delete_column(u'Ventas_detallepedido', 'unidadesPedido')
