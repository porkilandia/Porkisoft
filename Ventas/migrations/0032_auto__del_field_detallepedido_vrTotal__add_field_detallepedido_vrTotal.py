...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetallePedido.vrTotal'
        db.delete_column(u'Ventas_detallepedido', 'vrTotal')

        # Adding field 'DetallePedido.vrTotalPedido'
        db.add_column(u'Ventas_detallepedido', 'vrTotalPedido',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DetallePedido.vrTotal'
        db.add_column(u'Ventas_detallepedido', 'vrTotal',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DetallePedido.vrTotalPedido'
        db.delete_column(u'Ventas_detallepedido', 'vrTotalPedido')
