...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.descuadre'
        db.add_column(u'Ventas_venta', 'descuadre',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Venta.residuo'
        db.add_column(u'Ventas_venta', 'residuo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venta.descuadre'
        db.delete_column(u'Ventas_venta', 'descuadre')

        # Deleting field 'Venta.residuo'
        db.delete_column(u'Ventas_venta', 'residuo')
