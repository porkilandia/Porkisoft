...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfiguracionPuntos.bodega'
        db.add_column(u'Ventas_configuracionpuntos', 'bodega',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Inventario.Bodega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfiguracionPuntos.bodega'
        db.delete_column(u'Ventas_configuracionpuntos', 'bodega_id')
