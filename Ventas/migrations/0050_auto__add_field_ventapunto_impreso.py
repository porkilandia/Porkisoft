...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VentaPunto.impreso'
        db.add_column(u'Ventas_ventapunto', 'impreso',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VentaPunto.impreso'
        db.delete_column(u'Ventas_ventapunto', 'impreso')
    ...
    models = {
        ...
        u'Ventas.ventapunto': {
            ...
            'fechaVenta': ('django.db.models.fields.DateField', [], {}),
            'guardado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'impreso': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'jornada': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'numeroVenta': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
