...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Retiros.nombreEncargado'
        db.add_column(u'Ventas_retiros', 'nombreEncargado',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Retiros.nombreEncargado'
        db.delete_column(u'Ventas_retiros', 'nombreEncargado')
