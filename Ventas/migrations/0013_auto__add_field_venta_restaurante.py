...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.restaurante'
        db.add_column(u'Ventas_venta', 'restaurante',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venta.restaurante'
        db.delete_column(u'Ventas_venta', 'restaurante')
    ...
    models = {
        ...
        u'Ventas.venta': {
            ...
            'restaurante': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        }
    }
