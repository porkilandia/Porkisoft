...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.TotalRegistradora'
        db.add_column(u'Ventas_venta', 'TotalRegistradora',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venta.TotalRegistradora'
        db.delete_column(u'Ventas_venta', 'TotalRegistradora')
