...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DetalleVentaPunto.contado'
        db.delete_column(u'Ventas_detalleventapunto', 'contado')

        # Deleting field 'DetalleVentaPunto.credito'
        db.delete_column(u'Ventas_detalleventapunto', 'credito')


    def backwards(self, orm):
        # Adding field 'DetalleVentaPunto.contado'
        db.add_column(u'Ventas_detalleventapunto', 'contado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DetalleVentaPunto.credito'
        db.add_column(u'Ventas_detalleventapunto', 'credito',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
