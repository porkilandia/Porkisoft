...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetalleVenta.cliente'
        db.alter_column(u'Ventas_detalleventa', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Telemercadeo.Cliente'], null=True))
        # Adding field 'Venta.lista'
        db.add_column(u'Ventas_venta', 'lista',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Ventas.ListaDePrecios'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DetalleVenta.cliente'
        db.alter_column(u'Ventas_detalleventa', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Telemercadeo.Cliente']))
        # Deleting field 'Venta.lista'
        db.delete_column(u'Ventas_venta', 'lista_id')
