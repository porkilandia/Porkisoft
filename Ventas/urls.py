...
urlpatterns = patterns('',
    ...
    url(r'^editarDetpedido/(?P<idDetpedido>\d+)',EditarDetallePedido),
    ...
    url(r'^consultaTipoPedidoContado/$',ReporteTipoPedidoContado),
    ...
    url(r'^borraDetListaPrecios/(?P<idDetLista>\d+)',borrarItemListaPrecios),
